    ...
    def rewrite_claim(
        ...
        *,
        ...
        return self.create_claim(
            ...
            created_tau=int(closed_at),
            creditor_id=old_claim.creditor_id,
            debtor_id=old_claim.debtor_id,
            nominal=nominal,
            maturity_tau=maturity_tau,
            src_channel=int(old_claim.src_channel),
            dst_channel=int(old_claim.dst_channel),
